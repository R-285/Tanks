...
public class MediumEnemy extends OvarallEnemy{

    private MediumEnemy.Heading heading;
    private Map<MediumEnemy.Heading, Sprite> spriteMap;

    private enum Heading {
        NORTH_F(8 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE),
        WEST_F(10 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE),
        SOUTH_F(12 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE),
        EAST_F(14 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE),

        NORTH_S(9 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE),
        WEST_S(11 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE),
        SOUTH_S(13 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE),
        EAST_S(15 * SPRITE_SCALE, 5 * SPRITE_SCALE, 1 * SPRITE_SCALE, 1 * SPRITE_SCALE);
    ...
    MediumEnemy(float x, float y, float speed, Player player, TextureAtlas atlas, Graphics2D graphics) {
        super( x, y, speed);
        enemyBullet = new EnemyBullet(0, 0, atlas, player, graphics);
        heading = MediumEnemy.Heading.SOUTH_F;

        spriteMap = new HashMap<>();

        for (MediumEnemy.Heading h : MediumEnemy.Heading.values()) {
        ...
        switch (vector) {
            case DOWN:
                ...
                if (animationCount++ == SPEED_OF_ANIMATION) {
                    if ((heading == MediumEnemy.Heading.SOUTH_F)) heading = MediumEnemy.Heading.SOUTH_S;
                    else heading = MediumEnemy.Heading.SOUTH_F;
                    animationCount = 0;
                }
            ...
            case TOP:
                ...
                if (animationCount++ == SPEED_OF_ANIMATION) {
                    if ((heading == MediumEnemy.Heading.NORTH_F)) heading = MediumEnemy.Heading.NORTH_S;
                    else heading = MediumEnemy.Heading.NORTH_F;
                    animationCount = 0;
                }
            ...
            case LEFT:
                ...
                if (animationCount++ == SPEED_OF_ANIMATION) {
                    if ((heading == MediumEnemy.Heading.WEST_F)) heading = MediumEnemy.Heading.WEST_S;
                    else heading = MediumEnemy.Heading.WEST_F;
                    animationCount = 0;
                }
            ...
            case RIGHT:
                ...
                if (animationCount++ == SPEED_OF_ANIMATION) {
                    if ((heading == MediumEnemy.Heading.EAST_F)) heading = MediumEnemy.Heading.EAST_S;
                    else heading = MediumEnemy.Heading.EAST_F;
                    animationCount = 0;
                }
